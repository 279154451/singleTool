...
public final class FileKit {
    ...
    private static final String DEFAULT_FILE_COMPRESS_DIRECTORY_NAME = "qchatSend";
    public static String sendFileDir =Environment.getExternalStorageDirectory().getAbsolutePath()+"/QchatRemote/";
...
//        file = new File(sendFileDir, DEFAULT_FILE_COMPRESS_DIRECTORY_NAME);
        if (!file.exists())
            file.mkdirs();
        return file;
    }
